...
/*   Updated: 2023/07/21 21:20:28 by alexnshimiy      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	rc->textures[0] = load_png(game_info->west_texture);
	rc->textures[1] = load_png(game_info->east_texture);
	rc->textures[2] = load_png(game_info->north_texture);
	rc->textures[3] = load_png(game_info->south_texture);
}
