...
#    Updated: 2023/07/25 13:19:24 by anshimiy         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =  $(SRCDIR)main.c	$(SRCDIR)cub3d.c																								\
		...
		$(SRCDIR)$(RAYCAST)raycaster.c $(SRCDIR)$(RAYCAST)movements.c $(SRCDIR)$(RAYCAST)init.c $(SRCDIR)$(RAYCAST)walls.c $(SRCDIR)$(RAYCAST)spe_hooks.c		\
...
norm:
	@norminette $(SRCS) ./includes/**/*.h ./includes/my_lib/
